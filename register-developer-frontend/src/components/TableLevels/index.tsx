...
import ExcludeLevels from "../ExcludeLevels/index";
...
export default function TableLevels({
  ...
  const levelActions = useLevel();

  /** Edit modal options */
  const handleUpdateModal = (id: string) => {
    levelActions.setStatusModal(true);
    levelActions.setIdEditable(id);
  };
          ...
          <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg ">
                  ...
                  return (
                    <tr
                      ...
                      className={`hover:bg-gray-200 cursor-pointer ${
                        levelActions.containsExcludeItem(row.cells[0].value)
                          ? "bg-blue-200"
                          : ""
                      }`}
                      onClick={() => {
                        levelActions.containsExcludeItem(row.cells[0].value)
                          ? levelActions.removeExcludeItem(row.cells[0].value)
                          : levelActions.addExcludeItem(row.cells[0].value);
                      }}
                    >
                      {row.cells.map((cell) => {
                        return (
                      ...
                      >
                        <a
                          onClick={() => {
                            ...
                            levelActions.setTitle("Editar Nível");
                          }}
            ...
            <div className="flex justify-between">
              ...
              <ModalConfirmation
                ...
                message="Tem certeza que deseja excluir os níveis selecionados?"
              />
              <Pagination
                gotoPage={gotoPage}
